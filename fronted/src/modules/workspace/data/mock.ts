...
export const projectCards: ProjectCard[] = [
  {
    ...
    members: [
      { userId: 'user-zhangxiaoming', nickName: '张小明' },
      { userId: 'user-wangfang', nickName: '王芳' },
      { userId: 'user-zhaoli', nickName: '赵丽' },
    ],
    dueAt: '2026.03.20',
    progress: 68,
    status: '进行中',
  ...
  },
  {
    ...
    members: [
      { userId: 'user-wangfang', nickName: '王芳' },
      { userId: 'user-liuchen', nickName: '刘晨' },
    ],
    dueAt: '2026.04.01',
    progress: 42,
    status: '进行中',
  ...
  },
  {
    ...
    owner: '赵丽',
    ownerId: 'user-zhaoli',
    members: [{ userId: 'user-zhaoli', nickName: '赵丽' }],
    dueAt: '2026.05.15',
    progress: 15,
    status: '未开始',
    taskCount: 12,
